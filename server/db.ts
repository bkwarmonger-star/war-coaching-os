...
import { InsertUser, users, trainers, clients, programs, checkIns, messages, sessions, packages, subscriptions, leads, referrals, progressMetrics, InsertProgressMetric, bodyComposition, InsertBodyComposition, consultations, InsertConsultation, services, InsertService, documents, InsertDocument, payments, InsertPayment, localAuth, formTemplates, formSubmissions } from "../drizzle/schema";
